...
Programming Project Phase 4 (IN PROGRESS): : Implement RDT 3.0 over an unreliable UDP channel with bit-errors
...
This behavior is intentional to demonstrate the handling of errors in data transmission. Both the client and server print logs to the terminal, indicating the progress of file transmission and the occurrence
 of any errors or retries due to packet loss or corruption.
